...
class ScrappaClient:
    """Revived 2026-09-24: measured directly, autocomplete beats SE Ranking's
    `similar` on real yield (28-46% real-volume hit rate vs comparable) at a
    small fraction of the cost (1 credit/call flat vs 10 credits/keyword
    RETURNED), and SERP checks are ~33x cheaper here than SE Ranking's
    serp/classic task. `questions` stays on SE Ranking - no Scrappa
    equivalent, and it's the highest-precision source measured so far."""
